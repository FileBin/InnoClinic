...
using AuthorizationAPI.STS.Identity.Configuration;
using AuthorizationAPI.STS.Identity.Configuration.ApplicationParts;
using AuthorizationAPI.STS.Identity.Configuration.Constants;
using AuthorizationAPI.STS.Identity.Configuration.Interfaces;
using AuthorizationAPI.STS.Identity.Helpers.Localization;
using AuthorizationAPI.STS.Identity.Services;

namespace AuthorizationAPI.STS.Identity.Helpers
{
