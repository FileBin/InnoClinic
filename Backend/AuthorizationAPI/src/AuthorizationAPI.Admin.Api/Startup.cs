...
using AuthorizationAPI.Admin.Api.Configuration;
using AuthorizationAPI.Admin.Api.Configuration.Authorization;
using AuthorizationAPI.Admin.Api.Configuration.Constants;
using AuthorizationAPI.Admin.Api.ExceptionHandling;
using AuthorizationAPI.Admin.Api.Helpers;
using AuthorizationAPI.Admin.Api.Mappers;
using AuthorizationAPI.Admin.Api.Resources;
...
using AuthorizationAPI.Admin.EntityFramework.Shared.Entities.Identity;
using Skoruba.Duende.IdentityServer.Shared.Configuration.Helpers;
using AuthorizationAPI.Shared.Dtos;
using AuthorizationAPI.Shared.Dtos.Identity;

namespace AuthorizationAPI.Admin.Api
{
